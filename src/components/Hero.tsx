...
export default function Hero() {
  return (
    <section id="hero" className="relative h-dvh overflow-hidden bg-[#0B0A0B]">
      ...
      {/* Card 1 — Mini player */}
      <div
        className="absolute z-20 flex flex-col gap-4 rounded-[32px] p-4 md:rounded-[42px] md:p-5 backdrop-blur-xl"
        style={{
          width: "20%",
          top: "35%",
          left: "40%",
      ...
      >
        <div className="flex items-start gap-3">
          ...
          />
          <div>
            <p className="font-heading text-[0.75vw] font-bold leading-[1.4] text-white">
              Swipe to discover.
              <br />
              Stay to listen.
            </p>
            <p className="font-heading text-[0.6vw] leading-[1.4] text-white/50">
        ...
        <div className="w-full">
          <div className="flex items-center justify-between mb-1">
            <span className="font-heading text-[0.5vw] text-white/50">1:15</span>
            <span className="font-heading text-[0.5vw] text-white/50">3:42</span>
          </div>
      ...
      <div
        className="absolute z-20 flex items-center gap-2 rounded-[32px] px-4 py-3 md:rounded-[42px] md:pl-5 md:pr-3 md:py-4 backdrop-blur-xl"
        style={{
          width: "17%",
          top: "73%",
          left: "55%",
      ...
      >
        <div className="flex-1">
          <span className="font-heading text-[0.5vw] font-medium tracking-[0.2em] text-white/40 uppercase">
            Early Access
          </span>
          <p className="font-heading text-[0.75vw] font-bold leading-[1.4] text-white mt-1">
            Hear them first
          </p>
          <p className="font-heading text-[0.65vw] leading-[1.4] text-white/50">
          ...
          >
            ...
            <span className="font-heading text-[0.55vw] font-medium text-white">Join Waitlist</span>
          </a>
        </div>
        {/* Glassmorphic circle with earbuds */}
        <div
