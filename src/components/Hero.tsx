...
export default function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden bg-[#0B0A0B]">
      {/* ===== DESKTOP LAYOUT ===== */}
      <div className="relative hidden lg:block h-dvh">
        {/* Heading */}
        <h1
      ...
      {/* ===== MOBILE LAYOUT ===== */}
      <div className="relative lg:hidden h-dvh flex flex-col items-center px-2 pt-20 overflow-hidden">
        {/* Heading */}
        <h1 className="relative z-10 text-center font-heading font-semibold leading-[1] tracking-[0.02em] text-white text-[8vw]">
          For those who listen with
          <br />
          <span className="text-white/40">intention not impulse</span>
        </h1>

        {/* Phone + notification cards overlaying it */}
        <div className="relative mt-6 w-[80%] max-w-[300px] mx-auto flex-1">
          {/* Phone image */}
          <div className="absolute inset-0 overflow-hidden rounded-[10%/6%]">
            <Image
              src="/figma-designs-screenshot/assets/mobile-display-asset.png"
              alt=""
              fill
          ...
          {/* Notification cards — stacked like iOS notifications */}
          <div className="absolute inset-x-2 top-[12%] z-10 flex flex-col gap-2">
            {/* Card 1 */}
            <div
              className="flex items-center gap-2.5 rounded-[16px] px-3 py-2.5 backdrop-blur-xl"
              style={{
            ...
            >
              <Image src="/vectors/sound-wave-icon.png" alt="" width={28} height={28} className="w-7 h-7 opacity-90" />
              <div className="flex-1 min-w-0">
                <p className="font-heading text-[11px] font-bold leading-[1.3] text-white">Swipe to discover. Stay to listen.</p>
                <p className="font-heading text-[9px] leading-[1.3] text-white/50">Reels to full tracks, in one place</p>
              </div>
            </div>
            ...
            >
              <Image src="/vectors/album-cover.png" alt="" width={28} height={28} className="w-7 h-7 rounded-[4px]" />
              <div className="flex-1 min-w-0">
                <p className="font-heading text-[11px] font-bold leading-[1.3] text-white">Find what&apos;s next.</p>
                <p className="font-heading text-[9px] leading-[1.3] text-white/50">Not what an algorithm decides</p>
              </div>
            </div>
            ...
            >
              <Image src="/vectors/earbuds.png" alt="" width={24} height={24} className="w-6 h-6" />
              <div className="flex-1 min-w-0">
                <p className="font-heading text-[11px] font-bold leading-[1.3] text-white">Hear them first.</p>
                <p className="font-heading text-[9px] leading-[1.3] text-white/50">Before the world does</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          style={{
            height: "25%",
            background: "linear-gradient(360deg, #0B0A0B 20%, rgba(1, 1, 1, 0) 100%)",
          }}
        />
      </div>
    </section>
